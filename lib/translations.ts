...
From ancient times, Rwandans were protected and guided by the Holy God(God-Yera); they drank what is pure(ayera) — meaning milk — and lived from the fertility and nourishment of the soil(Ibyeze). Now a new season has come: God has once again remembered us and granted us Umwero for culture preservation.`,
    ...
    umweroKabbalah: "Umwero Foundations",
    cultureHistoryIntro: "Umwero connects Kinyarwanda writing with cultural identity and Rwandan heritage.",
    importanceOfWriting: "Umwero was created so Kinyarwanda could be represented through a writing system connected to its sounds and cultural roots.",
    originOfWriting: "Origin of Writing",
    firstWritingSystemsDate: "This page focuses on Umwero and Kinyarwanda.",
    writingAndPower: "Writing and Power",
    sargonExample: "Explore how writing can carry language, memory, and identity.",
    ...
    latinAlphabetDominance: "Kwizera noticed gaps between spoken Kinyarwanda and Latin-script writing.",
    ...
    umweroImportance: "Umwero is a writing system created for Kinyarwanda, cultural identity, linguistic preservation, and education.",
    ...
    // Umwero Movement
    umweroMovement: "Umwero and Uruziga",
    culturalRenaissance: "Cultural Preservation",
    ourMission: "Our Mission",
    preservingKinyarwandaCulture: "Preserving Kinyarwanda Culture",
    umweroAlphabetDescription: "Umwero is a writing system created by Kwizera Mugisha to represent Kinyarwanda while preserving Rwandan culture, identity, and linguistic heritage.",
    umweroQuote: "Every culture is protected by its language, and any language may be protected by its own writing system.",
    ourVision: "Our Vision",
    buildingCulturalSchool: "Building a Cultural School",
    visionDescription: "Uruziga helps learners study and practice the Umwero writing system.",
    schoolDescription: "Uruziga provides educational tools for learning Umwero.",
    joinMovement: "Learn Umwero",
    bePartOfRenaissance: "Study the Writing System",
    movementParticipationDescription: "Learn Umwero through guided lessons, writing practice, and cultural exploration.",
    startLearningUmwero: "Start Learning Umwero",
    joinUsInPreserving: "Join us in preserving Kinyarwanda culture",
    umweroMovementDescription: "A Kinyarwanda writing system taught through Uruziga",
    ...
    learnUmweroDesc: "Interactive lessons for learning the Umwero writing system",
  ...
  rw: {
    ...
    umweroKabbalah: "Imizi ya Umwero",
    ...
    firstWritingSystemsDate: "Iyi paji ishingira ku bumenyi bwanditse kuri Umwero n'Ikinyarwanda.",
    writingAndPower: "Inyandiko n'Ububasha",
    sargonExample: "Iyi ngingo ntiri mu bumenyi bwemewe bwa Umwero.",
    ...
    latinAlphabetDominance: "Ubumenyi bwa Umwero busobanura icyuho hagati y'Ikinyarwanda kivugwa n'uko cyandikwa mu nyuguti z'Ikilatini.",
    ...
    umweroImportance: "Umwero ni uburyo bwo kwandika Ikinyarwanda, buhuza ururimi, umuco, indangamuntu n'uburezi.",
    ...
    culturalRenaissance: "Kubungabunga Umuco",
    ourMission: "Intego Yacu",
    preservingKinyarwandaCulture: "Kubungabunga Umuco w'Ikinyarwanda",
    umweroAlphabetDescription: "Umwero ni uburyo bwo kwandika Ikinyarwanda bwahanzwe na Kwizera Mugisha, buhuza ururimi n'umuco nyarwanda.",
    umweroQuote: "Umuco urindwa n'ururimi, kandi ururimi rushobora kurindwa n'uburyo bwarwo bwo kwandika.",
    ourVision: "Icyerekezo Cyacu",
    buildingCulturalSchool: "Kubaka Ishuri ry'Umuco",
    visionDescription: "Uruziga ifasha abiga kwiga no kwimenyereza uburyo bwo kwandika Umwero.",
    schoolDescription: "Uruziga itanga ibikoresho by'uburezi byo kwiga Umwero.",
    joinMovement: "Injira mu Huriro",
    bePartOfRenaissance: "Iga Uburyo bwo Kwandika",
    movementParticipationDescription: "Iga Umwero ukoresheje amasomo, imyitozo yo kwandika, n'ibisobanuro bishingiye ku nyandiko zemewe.",
    ...
    umweroMovementDescription: "Uburyo bwo kwandika Ikinyarwanda bwigishwa kuri Uruziga",
...
welcomeToUmwero: "MURAKAZA NEZA MU URUZIGA",
    ...
    learnUmweroDesc: "Amasomo yo kwiga uburyo bwo kwandika Umwero",
  ...
  um: {
    ...
    historyOfWriting: "Amateka y'Inyandiko",
    umweroKabbalah: "Imizi ya Umwero",
    cultureHistoryIntro: "Ubumenyi bwa Umwero buhuza Ikinyarwanda, indangamuntu n'umuco nyarwanda.",
    importanceOfWriting: "Umwero wahanzwe kugira ngo Ikinyarwanda cyandikwe mu buryo bujyanye n'amajwi yacyo n'imizi y'umuco.",
    originOfWriting: "Inkomoko y'Inyandiko",
    firstWritingSystemsDate: "Iyi paji ishingira ku bumenyi bwanditse kuri Umwero n'Ikinyarwanda.",
    writingAndPower: "Inyandiko n'Ububasha",
    sargonExample: "Iyi ngingo ntiri mu bumenyi bwemewe bwa Umwero.",
