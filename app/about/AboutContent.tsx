  ...
  return (
    <div className="container mx-auto px-4 py-8 bg-[#FFFFFF]">
      <h1 className="text-4xl font-bold mb-6 text-center text-[#8B4513]">
        {t("umweroMovement")}: {t("culturalRenaissance")}
      </h1>
      ...
      <Card className="mb-8 bg-[#F3E5AB] border-[#8B4513]">
        ...
        <CardContent>
          <p className="mb-4 text-[#8B4513]">{t("umweroMovementDescription")}</p>
          <p className="mb-4 text-[#8B4513]">{t("umweroAlphabetDescription")}</p>
      ...
      <Card className="mb-8 bg-[#F3E5AB] border-[#8B4513]">
        ...
        <CardContent>
          <p className="mb-4 text-[#8B4513]">{t("visionDescription")}</p>
          <p className="mb-4 text-[#8B4513]">{t("schoolDescription")}</p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-[#F3E5AB] border-[#8B4513]">
        ...
        <CardContent>
          <p className="mb-4 text-[#8B4513]">{t("movementParticipationDescription")}</p>
