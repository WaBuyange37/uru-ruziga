...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-[#8B4513]/20 bg-white mt-auto w-full">
      <div className="w-full mx-auto px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-12 max-w-7xl">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex gap-2 sm:gap-3 pt-2">
              <a 
                ...
                className="h-8 w-8 sm:h-9 sm:w-9 rounded-full bg-[#8B4513] flex items-center justify-center text-white hover:bg-black transition-colors flex-shrink-0"
                aria-label="YouTube"
              >
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <a 
                  ...
                  className="text-xs sm:text-sm text-black/65 hover:text-[#8B4513] transition-colors break-all"
                >
                  37nzela@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <a 
                  ...
                  className="text-xs sm:text-sm text-black/65 hover:text-[#8B4513] transition-colors"
                >
                  +250 786 375 052
                </a>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <span className="text-xs sm:text-sm text-black/65">
                  Kigali, Rwanda
                </span>
              </li>
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#8B4513]/20 pt-4 sm:pt-6 mt-4 sm:mt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-xs sm:text-sm text-black/65 text-center sm:text-left">
              &copy; {currentYear} EraEinstain. {t('allRightsReserved')}
            </p>
            <div className="flex items-center gap-3 sm:gap-4 text-xs sm:text-sm text-black/65">
