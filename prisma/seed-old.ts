...
async function main() {
  ...
  const consonants = [
    ...
    {
      id: 'char-c', glyph: 'Ꮇ', latin: 'C', type: 'CONSONANT', diff: 2, strokes: 4, ord: 17,
  ...
  const specials = [
    ...
    { id: 'sp-question', glyph: '?', latin: '?', type: 'SPECIAL', diff: 1, strokes: 2, ord: 202, history: 'Question mark.' },
    { id: 'sp-equals', glyph: '=', latin: '=', type: 'SPECIAL', diff: 1, strokes: 2, ord: 203, history: 'Equals = represents "Umwero" name. Harvest fruit symbol.' },
    { id: 'sp-paren', glyph: '(', latin: '(', type: 'SPECIAL', diff: 1, strokes: 1, ord: 204, history: 'Opening bracket.' },
    { id: 'sp-paren', glyph: ')', latin: ')', type: 'SPECIAL', diff: 1, strokes: 1, ord: 205, history: 'Closing bracket.' },
    { id: 'sp-plus', glyph: '+', latin: '+', type: 'SPECIAL', diff: 1, strokes: 2, ord: 206, history: 'Plus/conjunction.' },
    { id: 'sp-dash', glyph: '-', latin: '-', type: 'SPECIAL', diff: 1, strokes: 1, ord: 207, history: 'Dash/hyphen.' },
  ];
  ...
  const allLessons = [
    ...
    {
      id: 'lesson-cons-c', title: 'Consonant C: Serpent\'s Wisdom', description: 'Serpent + pathway = wisdom & movement.',
      module: 'BEGINNER', type: 'CONSONANT', order: 11, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'char-c', code: 'CONS-C', content: JSON.stringify({ consonant: 'c', glyph: 'Ꮇ', ipa: '103+134' }), isPublished: true
    },
    {
    ...
    // Ibihekane (Ligature) lessons
    // Individual Ibihekane Lessons - Each ligature is an independent pedagogical unit
    // Prenasalized compounds (N+)
    {
      id: 'lesson-ibihekane-nd', title: 'Igihekane ND', description: 'Learn the prenasalized sound ND.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 18, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nd', code: 'IBIHEKANE-ND',
      content: JSON.stringify({
        ligature: 'Nd', latinEquivalent: 'Nd', structure: 'N + D', pronunciation: '/ⁿd/',
        examples: [
          { word: 'Gukunda', meaning: 'to love' },
          { word: 'Inda', meaning: 'stomach' },
          { word: 'Indege', meaning: 'airplane' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-ng', title: 'Igihekane NG', description: 'Learn the prenasalized sound NG.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 19, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-ng', code: 'IBIHEKANE-NG',
      content: JSON.stringify({
        ligature: 'Ng', latinEquivalent: 'Ng', structure: 'N + G', pronunciation: '/ŋg/',
        examples: [
          { word: 'Ingo', meaning: 'homes' },
          { word: 'Ingoma', meaning: 'drum' },
          { word: 'Ingwe', meaning: 'leopard' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nj', title: 'Igihekane NJ', description: 'Learn the prenasalized sound NJ.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 20, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nj', code: 'IBIHEKANE-NJ',
      content: JSON.stringify({
        ligature: 'Nj', latinEquivalent: 'Nj', structure: 'N + J', pronunciation: '/ⁿdʒ/',
        examples: [
          { word: 'Inja', meaning: 'dog' },
          { word: 'Injangwe', meaning: 'cat' },
          { word: 'Injiza', meaning: 'entrance' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nz', title: 'Igihekane NZ', description: 'Learn the prenasalized sound NZ.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 21, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nz', code: 'IBIHEKANE-NZ',
      content: JSON.stringify({
        ligature: 'Nz', latinEquivalent: 'Nz', structure: 'N + Z', pronunciation: '/ⁿz/',
        examples: [
          { word: 'Inzu', meaning: 'house' },
          { word: 'Inzira', meaning: 'path' },
          { word: 'Inzoga', meaning: 'beer' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nk', title: 'Igihekane NK', description: 'Learn the prenasalized sound NK.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 22, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nk', code: 'IBIHEKANE-NK',
      content: JSON.stringify({
        ligature: 'Nk', latinEquivalent: 'Nk', structure: 'N + K', pronunciation: '/ŋk/',
        examples: [
          { word: 'Inkuru', meaning: 'story' },
          { word: 'Inkoko', meaning: 'chicken' },
          { word: 'Inkoni', meaning: 'stick' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-ns', title: 'Igihekane NS', description: 'Learn the prenasalized sound NS.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 23, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-ns', code: 'IBIHEKANE-NS',
      content: JSON.stringify({
        ligature: 'Ns', latinEquivalent: 'Ns', structure: 'N + S', pronunciation: '/ⁿs/',
        examples: [
          { word: 'Inseko', meaning: 'laughter' },
          { word: 'Insigamire', meaning: 'last born' },
          { word: 'Insonga', meaning: 'reason' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nsh', title: 'Igihekane NSH', description: 'Learn the prenasalized sound NSH.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 24, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nsh', code: 'IBIHEKANE-NSH',
      content: JSON.stringify({
        ligature: 'Nsh', latinEquivalent: 'Nsh', structure: 'N + SH', pronunciation: '/ⁿʃ/',
        examples: [
          { word: 'Inshuti', meaning: 'friend' },
          { word: 'Inshuro', meaning: 'times' },
          { word: 'Inshingano', meaning: 'responsibility' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nt', title: 'Igihekane NT', description: 'Learn the prenasalized sound NT.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 25, duration: 10, difficulty: 2, estimatedTime: 10,
      characterId: 'lig-nt', code: 'IBIHEKANE-NT',
      content: JSON.stringify({
        ligature: 'Nt', latinEquivalent: 'Nt', structure: 'N + T', pronunciation: '/ⁿt/',
        examples: [
          { word: 'Intama', meaning: 'sheep' },
          { word: 'Intego', meaning: 'goal' },
          { word: 'Intoki', meaning: 'banana' }
        ]
      }), isPublished: true
    },

    // Labialized compounds (W-family)
    {
      id: 'lesson-ibihekane-bw', title: 'Igihekane BW', description: 'Learn the labialized sound BW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 26, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-bw', code: 'IBIHEKANE-BW',
      content: JSON.stringify({
        ligature: 'Bw', latinEquivalent: 'Bw', structure: 'B + W', pronunciation: '/bw/',
        examples: [
          { word: 'Ubwato', meaning: 'boat' },
          { word: 'Ubwiza', meaning: 'beauty' },
          { word: 'Kubwira', meaning: 'to tell' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-cw', title: 'Igihekane CW', description: 'Learn the labialized sound CW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 27, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-cw', code: 'IBIHEKANE-CW',
      content: JSON.stringify({
        ligature: 'Cw', latinEquivalent: 'Cw', structure: 'C + W', pronunciation: '/tʃw/',
        examples: [
          { word: 'Icwa', meaning: 'thorn' },
          { word: 'Gucwa', meaning: 'to dawn' },
          { word: 'Mucwa', meaning: 'in the morning' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-dw', title: 'Igihekane DW', description: 'Learn the labialized sound DW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 28, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-dw', code: 'IBIHEKANE-DW',
      content: JSON.stringify({
        ligature: 'Dw', latinEquivalent: 'Dw', structure: 'D + W', pronunciation: '/dw/',
        examples: [
          { word: 'Indwara', meaning: 'illness' },
          { word: 'Indwi', meaning: 'louse' },
          { word: 'Gukudwa', meaning: 'to be loved' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-fw', title: 'Igihekane FW', description: 'Learn the labialized sound FW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 29, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-fw', code: 'IBIHEKANE-FW',
      content: JSON.stringify({
        ligature: 'Fw', latinEquivalent: 'Fw', structure: 'F + W', pronunciation: '/fw/',
        examples: [
          { word: 'Ifwa', meaning: 'death' },
          { word: 'Gufwa', meaning: 'to die' },
          { word: 'Umufwa', meaning: 'dead person' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-gw', title: 'Igihekane GW', description: 'Learn the labialized sound GW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 30, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-gw', code: 'IBIHEKANE-GW',
      content: JSON.stringify({
        ligature: 'Gw', latinEquivalent: 'Gw', structure: 'G + W', pronunciation: '/gw/',
        examples: [
          { word: 'Igwa', meaning: 'to fall' },
          { word: 'Ubugwa', meaning: 'falling' },
          { word: 'Kugwa', meaning: 'to fall' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-kw', title: 'Igihekane KW', description: 'Learn the labialized sound KW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 31, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-kw', code: 'IBIHEKANE-KW',
      content: JSON.stringify({
        ligature: 'Kw', latinEquivalent: 'Kw', structure: 'K + W', pronunciation: '/kw/',
        examples: [
          { word: 'Ikwa', meaning: 'hoe' },
          { word: 'Ukwa', meaning: 'fig tree' },
          { word: 'Gukwa', meaning: 'to hoe' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-mw', title: 'Igihekane MW', description: 'Learn the labialized sound MW.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 32, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-mw', code: 'IBIHEKANE-MW',
      content: JSON.stringify({
        ligature: 'Mw', latinEquivalent: 'Mw', structure: 'M + W', pronunciation: '/mw/',
        examples: [
          { word: 'Umwana', meaning: 'child' },
          { word: 'Umwami', meaning: 'king' },
          { word: 'Umwuka', meaning: 'spirit' }
        ]
      }), isPublished: true
    },

    // Palatalized compounds (Y-family)
    {
      id: 'lesson-ibihekane-by', title: 'Igihekane BY', description: 'Learn the palatalized sound BY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 33, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-by', code: 'IBIHEKANE-BY',
      content: JSON.stringify({
        ligature: 'By', latinEquivalent: 'By', structure: 'B + Y', pronunciation: '/bj/',
        examples: [
          { word: 'Ibyaha', meaning: 'sins' },
          { word: 'Ibyiza', meaning: 'good things' },
          { word: 'Byose', meaning: 'everything' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-fy', title: 'Igihekane FY', description: 'Learn the palatalized sound FY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 34, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-fy', code: 'IBIHEKANE-FY',
      content: JSON.stringify({
        ligature: 'Fy', latinEquivalent: 'Fy', structure: 'F + Y', pronunciation: '/fj/',
        examples: [
          { word: 'Ifya', meaning: 'to ripen' },
          { word: 'Gufya', meaning: 'to cook' },
          { word: 'Umufyisi', meaning: 'cook' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-jy', title: 'Igihekane JY', description: 'Learn the palatalized sound JY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 35, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-jy', code: 'IBIHEKANE-JY',
      content: JSON.stringify({
        ligature: 'Jy', latinEquivalent: 'Jy', structure: 'J + Y', pronunciation: '/dʒj/',
        examples: [
          { word: 'Ijya', meaning: 'it goes' },
          { word: 'Kujya', meaning: 'to go' },
          { word: 'Ujya', meaning: 'you go' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-my', title: 'Igihekane MY', description: 'Learn the palatalized sound MY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 36, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-my', code: 'IBIHEKANE-MY',
      content: JSON.stringify({
        ligature: 'My', latinEquivalent: 'My', structure: 'M + Y', pronunciation: '/mj/',
        examples: [
          { word: 'Imyaka', meaning: 'years' },
          { word: 'Imyenda', meaning: 'clothes' },
          { word: 'Imyitwarire', meaning: 'behavior' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-py', title: 'Igihekane PY', description: 'Learn the palatalized sound PY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 37, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-py', code: 'IBIHEKANE-PY',
      content: JSON.stringify({
        ligature: 'Py', latinEquivalent: 'Py', structure: 'P + Y', pronunciation: '/pj/',
        examples: [
          { word: 'Ipya', meaning: 'new' },
          { word: 'Gupya', meaning: 'to renew' },
          { word: 'Impyisi', meaning: 'hyena' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-sy', title: 'Igihekane SY', description: 'Learn the palatalized sound SY.',
      module: 'INTERMEDIATE', type: 'LIGATURE', order: 38, duration: 10, difficulty: 3, estimatedTime: 10,
      characterId: 'lig-sy', code: 'IBIHEKANE-SY',
      content: JSON.stringify({
        ligature: 'Sy', latinEquivalent: 'Sy', structure: 'S + Y', pronunciation: '/sj/',
        examples: [
          
          { word: 'Gusya', meaning: 'to grind' },
          { word: 'Umusyi', meaning: 'grinder' }
        ]
      }), isPublished: true
    },
    ...
    // Complex compounds
    {
      id: 'lesson-ibihekane-byw', title: 'Igihekane BYW', description: 'Learn the complex compound BYW.',
      module: 'ADVANCED', type: 'LIGATURE', order: 39, duration: 15, difficulty: 4, estimatedTime: 15,
      characterId: 'lig-byw', code: 'IBIHEKANE-BYW',
      content: JSON.stringify({
        ligature: 'Byw', latinEquivalent: 'Byw', structure: 'B + Y + W', pronunciation: '/bjw/',
        examples: [
          { word: 'Ibywa', meaning: 'drinks' },
          { word: 'Kubywa', meaning: 'to be drunk' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-myw', title: 'Igihekane MYW', description: 'Learn the complex compound MYW.',
      module: 'ADVANCED', type: 'LIGATURE', order: 40, duration: 15, difficulty: 4, estimatedTime: 15,
      characterId: 'lig-myw', code: 'IBIHEKANE-MYW',
      content: JSON.stringify({
        ligature: 'Myw', latinEquivalent: 'Myw', structure: 'M + Y + W', pronunciation: '/mjw/',
        examples: [
          { word: 'Imywa', meaning: 'thorns' },
          { word: 'Kumywa', meaning: 'to be thorny' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-nshyw', title: 'Igihekane NSHYW', description: 'Learn the complex compound NSHYW.',
      module: 'ADVANCED', type: 'LIGATURE', order: 41, duration: 15, difficulty: 4, estimatedTime: 15,
      characterId: 'lig-nshyw', code: 'IBIHEKANE-NSHYW',
      content: JSON.stringify({
        ligature: 'Nshyw', latinEquivalent: 'Nshyw', structure: 'N + SH + Y + W', pronunciation: '/nʃjw/',
        examples: [
          { word: 'Nshywe', meaning: 'I was taken' },
          { word: 'Nshyweho', meaning: 'I was put there' }
        ]
      }), isPublished: true
    },
    {
      id: 'lesson-ibihekane-mbyw', title: 'Igihekane MBYW', description: 'Learn the complex compound MBYW.',
      module: 'ADVANCED', type: 'LIGATURE', order: 42, duration: 15, difficulty: 4, estimatedTime: 15,
      characterId: 'lig-mbyw', code: 'IBIHEKANE-MBYW',
      content: JSON.stringify({
        ligature: 'Mbyw', latinEquivalent: 'Mbyw', structure: 'MB + Y + W', pronunciation: '/mbjw/',
        examples: [
          { word: 'Mbywaho', meaning: 'I was put there' },
          { word: 'Mbywemo', meaning: 'I was put inside' }
        ]
      }), isPublished: true
    },
    ...
    // Culture lessons
    {
      ...
      module: 'BEGINNER', type: 'CULTURE', order: 43, duration: 15, difficulty: 1, estimatedTime: 15,
    ...
    },
    {
      ...
      module: 'INTERMEDIATE', type: 'CULTURE', order: 44, duration: 15, difficulty: 2, estimatedTime: 15,
    ...
    },
    {
      ...
      module: 'BEGINNER', type: 'CULTURE', order: 45, duration: 10, difficulty: 1, estimatedTime: 10,
